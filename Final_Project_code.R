...
split2 = sample.split(missing_d.train,SplitRatio = 0.75)
finalmissing_trainingset <- subset(missing_d.train,split2==TRUE)
write.csv(final_trainingset,"data30.train")
write.csv(finalmissing_trainingset,"finalmissing_trainingset")
